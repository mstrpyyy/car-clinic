...
export default function TicketForm({ customer, ticket, techs, isEditable = true, userEmail, isManager = false }: TicketFormProps) {
        ...
        <div className="flex max-xl:flex-col gap-4 min-h-[100px]">
            <div className="flex-1 xl:max-w-md">
                <div className="sticky top-8 overflow-y-auto">
                    <DashboardHeader 
                        headingText={ticket?.id
                                ? `Edit Ticket # ${ticket.id}`
                                : "New Ticket Form"
                            }
                        returnUrl="/dashboard/tickets/"
                        returnText="Return to Tickets"
                    />
                    <aside>
            ...
            <main className="flex-1  xl:mt-20">
                <DivWrapper className="space-y-4">
                        ...
                        >
                                ...
                                {isManager ? 
                                    ...
                                    <InputWithLabel<InsertTicketSchemaType>
                                        ...
                                        nameInSchema="tech"
                                        disabled={true}
                                        placeholder={userEmail && isEditable ? userEmail : 'Unassigned'}
                                    />
                                }
